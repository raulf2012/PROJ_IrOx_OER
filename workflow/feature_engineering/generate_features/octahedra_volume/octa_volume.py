...
# #########################################################
from local_methods import process_row_2
#  as process_row
...
# if True:
#     # ('nersc', 'fosurufu_23', 'o', 43.0, 1)
#     # ('nersc', 'hevudeku_30', 'o', 74.0, 1)
#     compenv_i = "nersc"
#     slab_id_i = "hevudeku_30"
#     group = grouped.get_group((compenv_i, slab_id_i, ))
    ...
    # for active_site_i in [86., ]:
        ...
        # print("name_tmp_i:", name_tmp_i)

        if name_tmp_i not in df_octa_info.index:
            systems_not_in_octa_info.append(name_tmp_i)
            # print("OOOPS")
...
# ### Building `df_octa_vol`

# +
# # TEMP
# print(111 * "TEMP | ")

# df_feat_rows = df_feat_rows.loc[[765]]
